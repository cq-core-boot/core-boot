...
import com.cq.core.boot.codegen.processor.controller.GenControllerProcessor;
import com.cq.core.boot.codegen.processor.creator.CreatorCodeGenProcessor;
import com.cq.core.boot.codegen.processor.creator.GenCreator;
import com.cq.core.boot.codegen.processor.mapper.GenMapper;
import com.cq.core.boot.codegen.processor.mapper.GenMapperProcessor;
import com.cq.core.boot.codegen.processor.query.GenQuery;
import com.cq.core.boot.codegen.processor.query.GenQueryProcessor;
import com.cq.core.boot.codegen.processor.repository.GenRepository;
import com.cq.core.boot.codegen.processor.repository.GenRepositoryProcessor;
...
import com.cq.core.boot.codegen.processor.service.GenServiceImplProcessor;
import com.cq.core.boot.codegen.processor.service.GenServiceProcessor;
import com.cq.core.boot.codegen.processor.updater.GenUpdater;
import com.cq.core.boot.codegen.processor.updater.GenUpdaterProcessor;
...
//    System.out.println(javaFile);
  ...
  protected void genJavaFile(String packageName, TypeSpec.Builder typeSpecBuilder) {
    JavaFile javaFile = JavaFile.builder(packageName, typeSpecBuilder.build())
            .addFileComment("---Auto Generated by CodeGen ---").build();
    try {
